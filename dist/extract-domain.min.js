...
for(f=d;f--;)if(-1!==k.indexOf(a[f])){g=f+1;break}return 6>g?"":a.slice(g,b)}var h=["/",":","?","#"],k=[".","/","@"];d.exports=function(a){if("string"===typeof a)return b(a);if(Array.isArray(a)){var d=[],e,g=0;for(e=a.length;g<e;g++)d.push(b(a[g]));return d}c()}}])});