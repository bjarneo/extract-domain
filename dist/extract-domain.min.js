...
for(f=d;f--;)if(-1!==k.indexOf(a[f])){g=f+1;break}if(2>g)return"";a=a.slice(g,b);return"www."===a.substring(0,4)?a.slice(4,b):a}var h=["/",":","?","#"],k=["/","@"];d.exports=function(a){if("string"===typeof a)return b(a);if(Array.isArray(a)){var d=[],e,g=0;for(e=a.length;g<e;g++)d.push(b(a[g]));return d}c()}}])});